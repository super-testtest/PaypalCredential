...
class Tailored_Goshippo_Model_Carrier extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    )
    {
        ...
        print_r($toAddress);exit;
       // Mage::log(print_r($toAddress,true));exit;
        //echo '<pre>';print_r($fromAddress);print_r($toAddress);print_r($parcel);
      /*  Mage::log(print_r($fromAddress,true)print_r($toAddress,true)print_r($parcel,true));exit;*/
        //Mage::log(print_r($fromAddress));
