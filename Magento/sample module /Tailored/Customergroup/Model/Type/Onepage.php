 ...
 */
class Tailored_Customergroup_Model_Type_Onepage extends Mage_Checkout_Model_Type_Onepage
{
    /**
    ...
    {
        $_SESSION['billing_group_id'] = $data['group_id'];
        if (empty($data)) {
            return array('error' => -1, 'message' => Mage::helper('checkout')->__('Invalid data.'));
        }
    ...
    protected function _prepareNewCustomerQuote()
    {
        ...
        $quote->setCustomer($customer)
            ->setCustomerId(true);
        $customer->setGroupId($_SESSION['billing_group_id']);
    }
